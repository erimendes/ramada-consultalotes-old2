		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consulta Lotes",
									"targetURL": "#sapramadappconsultalotes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapramadappconsultalotes-display": {
								"semanticObject": "sapramadappconsultalotes",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ramada.pp.consultalotes",
									"url": sap.ui.require.toUrl("sap/ramada/pp/consultalotes")
								}
							}
						}
					}
